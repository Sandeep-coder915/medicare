...
const ServiceCard = ({ item, index }) => {
    ...
    return (
        ...
        <div className='bg-white dark:bg-gray-800 dark:text-white rounded-lg shadow-md py-8 px-6 text-center hover:shadow-lg transition duration-300'>
            ...
            <div className='flex items-center justify-between mt-[30px]'>
                <Link to='/doctors' className="w-[44px]  h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none bg-blue-500 ">
                    <BsArrowRight className='group-hover:text-white w-6 h-5 bg-blue-500 ' />
                </Link>
