...
const DoctorDetails = () => {
  ...
  const { name, qualifications, experiences,
    timeSlots, reviews, bio, about, averageRating, totalRating, specialization, ticketPrice, photo,
  } = doctor
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <div className="flex items-centergap-[6px] ">
                    ...
                    <span className='text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-semibold text-headingColor text-[400]'>{totalRating}</span>
                  </div>
